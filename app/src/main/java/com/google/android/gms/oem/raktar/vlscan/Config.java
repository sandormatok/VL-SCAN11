...
public class Config {
    ...
    //static final String DATA_RAKTAR_KESZLET_URL = "http://192.168.0.19/raktar_keszlet_san.php?id=";
    static final String DATA_RAKTAR_KESZLET_URL = "http://192.168.1.108/raktar_keszlet_san.php?id=";
